 ...
 */
int ServerContextImpl::handleOcspStapling(SSL *ssl) {
...
ServerContextImpl::selectTlsContext(const SSL* ssl) {
  ...
  case OcspStapleAction::Staple: {
    ...
    // "ex data", which then gets picked up by the subsequent handleOcspStapling() callback which
